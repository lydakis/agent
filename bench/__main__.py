...
def run(args):
    ...
    if args.engine != "fixture":
        ...
        command, metadata, args.executable = engine_target(args.engine, root, args.binary)
...
def main():
    ...
    run_parser.add_argument("--engine", choices=("fixture", "pi", "codex", "rust", "fx", "claude-code"), default="fixture")
