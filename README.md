...
- [Live fleet check](docs/LIVE_FLEET.md): up to 1,024 concurrent bots on real providers through one daemon, and 64 bots sustained for five minutes with no drift.
...
Next: store retention, since a sustained fleet grows the store at about
3 KB per turn, then compaction with summaries. Keep matched regression
